                                    ...
                                    <div class="col-lg-12 col-md-12" style="margin-top:0px;">
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          ...
                                          <form action ="<?= base_url(); ?>/teamlead/searchdateext/<?php print_r($rqstby); ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">   
                                        <a href="<?= base_url(); ?>/teamlead/downloadreportextindv/<?php print_r($rqstby); ?>">
                                        ...
                                        ?>
                                          <a href="<?= base_url(); ?>/teamlead/downloadreportextindvext/<?php print_r($rqstby); ?>/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                            <button class="btn btn-sm btn-info">
                                        ...
                                        <tbody>
                                         ...
                                         ?>
                                            ...
                                            <tr>
                                                ...
                                                <th id="balcls<?= $i; ?>">
                                                  <button class="btn btn-sm btn-info" onclick="getbal('<?= $detailss["mobileNumber"]; ?>','<?= $i; ?>');"> Get Balance </button>
                                                </th>
                                            </tr>
