                                    ...
                                    <div class="col-lg-12 col-md-12" style="margin-top:0px;">
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          ...
                                          <form action ="<?= base_url(); ?>/teamlead/searchdate" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <a href="<?= base_url(); ?>/teamlead/downloadreportnew">
                                          ...
                                          ?>
                                              <a href="<?= base_url(); ?>/teamlead/downloadreportnewdate/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      <?php
                                                         if(isset($datadatebetween)){
                                                      ?>
                                                        <a href="<?= base_url(); ?>/teamlead/searchdateii/<?= $saledata["salesagentId"]; ?>/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>"> <button class="btn btn-sm btn-info"> View Report </button> </a>
                                                      <?php
                                                         }else{
                                                      ?>
                                                        <a href="<?= base_url(); ?>/teamlead/newcustomerreport/<?= $saledata["salesagentId"]; ?>"> <button class="allocated-button btn btn-sm btn-info"> View Report </button> </a>
                                                      <?php
                                                         }
                                                      ?>
                                                    </td>
