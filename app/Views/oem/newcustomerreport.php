				...
				<div class="container-fluid">
					...
					<div class="row" style="margin-top: -10px;"> <!--  -->
						<div class="col-lg-12 col-md-12">
							<div class="card row" style="overflow:scroll;"> <!-- style="overflow:scroll;" -->
								<div class="card-body">	
                                ...
                                <?php } ?>
                                  <!-- overflow-x:auto; table-responsive -->
                                        ...
                                        <div class="col-md-12 report-bx">
                                          <div class="row">
                                             <div class="col-md-3">
                                               ...
                                               <form action ="<?= base_url(); ?>/oem/searchdate" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                             ...
                                             <div class="col-md-3">
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -1 days' ) ); ?>/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -1 days' ) ); ?>">
                                               ...
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportlstwek">
                                                     <button class="allocated-button btn btn-info" style="width:100%;">
                                               ...
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -15 days' ) ); ?>/<?= date("Y-m-d"); ?>">
                                                     <button class="allocated-button btn btn-info" style="width:100%;">
                                               ...
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -1 month' ) ); ?>/<?= date("Y-m-d"); ?>">
                                                     <button class="allocated-button btn btn-info" style="width:100%;">
                                             ...
                                             <div class="col-md-3">                                               
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -3 month' ) ); ?>/<?= date("Y-m-d"); ?>">
                                                     <button class="allocated-button btn btn-info" style="width:100%;">
                                               ...
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -6 month' ) ); ?>/<?= date("Y-m-d"); ?>">
                                                     <button class="allocated-button btn btn-info" style="width:100%;">
                                               ...
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                   <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= date( 'Y-m-d', strtotime( date("Y-m-d") . ' -12 month' ) ); ?>/<?= date("Y-m-d"); ?>">
                                                     <button class="allocated-button btn btn-info" style="width:100%;">
                                               ...
                                               <div class="form-group row">
                                                 <div class="col-md-12">
                                                    <a href="<?= base_url(); ?>/oem/downloadreportnew">
                                                      <button class="allocated-button btn btn-info" style="width:100%;">
                                             ...
                                             <div class="col-md-3">
                                                 ...
                                                 ?>
                                                    <div class="form-group row">
                                                     <div class="col-md-12">
                                                        <a href="<?= base_url(); ?>/oem/downloadreportnewsrch/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                          <button class="allocated-button btn btn-info" style="width:100%;">
                                    ...
                                    <table class="table table-bordered justify-content-center table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
                                                ...
                                                <th style="padding: 10px 10px;">PAN Card Number</th>
                                        ...
                                        <tbody>
                                         ...
                                         ?>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                  <a href="<?= base_url(); ?>/oem/fitmenchallan/<?= $detailss["initialId"]; ?>" target="_blank">
                                                   <button class="allocated-button btn btn-sm btn-info">
                                                     Download Fitmen Challan
                                                   </button>
                                                  </a>
                                                  <a href="<?= base_url(); ?>/oem/fitmenchallanreceipt/<?= $detailss["initialId"]; ?>" target="_blank">
                                                   <button class="allocated-button btn btn-sm btn-info mt-1">
                                                     Download Receipt
                                                   </button>
                                                  </a>
                                                </th>
