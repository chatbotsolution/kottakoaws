    ...
    <div class="container mt-3 mb-3">
        <div class="col-md-8 mx-auto">
            <form action="" method="post" enctype="multipart/form-data">
                <h2 class="text-center text-danger">Sales Agent</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <label for="alternum" class="text-primary">Mobile Number</label>
                    <input type="number" id="alternum" name="alternum" placeholder="enter alternative mobile number" value="" class="form-control" onfocus="abc(this)" onblur="bcd(this)">
                </div>
            </div>
            ...
            <div class="row form-group">
                <div class="col-md-12">
                    <label for="city" class="text-primary">Toll Name or City Name</label>
                    <select name="" id="city" class="form-control" onfocus="abc(this)" onblur="bcd(this)">
                        <option value="">--select--</option>
                        <option value="bbsr">bbsr</option>
                        <option value="bbsr">bbsr</option>
