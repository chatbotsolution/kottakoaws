                                    ...
                                    <table class="table table-bordered table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
												...
												<th style="padding: 10px 10px;">Chassis Number</th>
                                                <th style="padding: 10px 10px;">Vehicle RC</th>
                                                <th style="padding: 10px 10px;">Contact Number</th>
                                                <th style="padding: 10px 10px;">RC Uploaded</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $saledata["chassisnumber"]; ?></td>
                                                    <td><?= $saledata["vehiclerc"]; ?></td>
                                                    <td><?= $saledata["contactnumber"]; ?></td>
                                                    <td><a href="<?= $saledata["vehicleuploadrc"]; ?>" download> <i class="fa fa-download"></i> </a> </td>
                                                    <td>
                                                       <button class="btn btn-sm btn-info" onclick="updt('0','<?= $saledata["vehicleupdateid"]; ?>');">
                                                          Approve
                                                       </button>
                                                       <button class="btn btn-sm btn-danger" onclick="updt('1','<?= $saledata["vehicleupdateid"]; ?>');">
                                                          Decline
                                                       </button>
                                                    </td>                                                    
                                                </tr>
...
function updt(updtval,updtid){
  
  $.ajax({
    type:'post',
    data:{updtval:updtval,updtid:updtid},
    url:'<?= base_url(); ?>/secure/vehclupdtreqst',
