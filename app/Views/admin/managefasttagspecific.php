                                ...
                                <?php } ?>
                                    <div class="col-lg-12 col-md-12" style="margin-top:10px;">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                <input type="number" onkeypress="if(this.value.length == 7){ return false;}" name="firstnum" id="firstnum" value="<?= set_value('firstnum'); ?>" Placeholder="Barcode First Number (00X-68XXXXXX)" class="form-control mg-b-10" style="width: 224.5px;height: 33.25px;">
                                                <span class="frstnum errmsg" style="text-align:left;"></span>
                                            </div>
                                          	<div class="col-sm-3">
                                                <input type="number" onkeypress="if(this.value.length == 7){ return false;}" name="lastnum" id="lastnum" value="<?= set_value('lastnum'); ?>" Placeholder="Barcode Last Number (00X-68XXXXXX)" class="form-control mg-b-10" style="width: 224.5px;height: 33.25px;">
                                    ...
                                    <table class="table table-bordered table-data">
                                      ...
                                      <div class="d-flex justify-content-end">
                                          <?php if ($pager) :?>
                                          <?php $pagi_path='secure/managefasttag/'.$type.''; ?>
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data =="verified"){
                        ...
                        $('.otppsndt').html('Invalid OTP ! Try Again');
                    }
                }
            });
        }
