                                      ...
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <?php $date = date("Y-m-d"); $day_before = date( 'Y-m-d', strtotime( $date . ' -1 day' ) ); ?>
                                            <form action ="<?= base_url(); ?>/secure/saextreportdetails/<?= $slctid; ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>                                          
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <a href="<?= base_url(); ?>/salesmanager/downloadindvtl/">
                                          ...
                                          ?>
                                              <a href="<?= base_url(); ?>/salesmanager/downloadreportnewdate/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                <button class="btn btn-sm btn-info">
