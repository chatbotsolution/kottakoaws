                                    ...
                                    <table class="table table-bordered table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
                                                ...
                                                <th style="padding: 10px 10px;">Toll &amp; City</th>
                                                <th style="padding: 10px 10px;">KYC Status</th>
                                                <th style="padding: 10px 10px;">Bank Verification</th>
                                                <th style="padding: 10px 10px;">Wallet Balance</th>
                                            ...
                                            <?php 
                                                ...
                                                foreach($salesagent as $saledata):
                                                    ...
                                                    if($saledata["status"] == 0){
                                                        $sts="Active";
                                                        $btn = '<a href="'.base_url().'/secure/updtsalesagentstatus/'.$saledata["salesagentId"].'/1"> <button class="btn btn-sm btn-danger"> Block </button> </a>';
                                                    }else if($saledata["status"] == 1){
                                                        $sts="Blocked";
                                                        $btn='<a href="'.base_url().'/secure/updtsalesagentstatus/'.$saledata["salesagentId"].'/0"> <button class="btn btn-sm btn-primary"> Un-Block </button> </a>';
                                                    }else if($saledata["status"] == 2){
                                                        $sts="Request Pending";
                                                        $btn='';
                                                    }else if($saledata["status"] == 3){
                                                        $sts="Request Declined";
                                                        $btn='<a href="'.base_url().'/secure/updtsalesagentstatus/'.$saledata["salesagentId"].'/0">    <button class="btn btn-sm btn-success"> Approve </button> </a>';
                                                    }
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    ...
                                                    <td><?= $kyc; ?></td>
                                                    <td><?= $bankkyc; ?></td>
                                                    <td>Rs. <?= number_format($pending[$j],2); ?></td>
                                                    <td><?= $sts; ?></td>
                                                    <td>
                                                        <?= $btn; ?>
                                                        <a href="<?= base_url(); ?>/secure/managesalesagent/<?= $saledata["salesagentId"]; ?>"> <button class="btn btn-sm btn-info"> View </button> </a>
                                                        <a href="<?= base_url(); ?>/secure/editsalesagent/<?= $saledata["salesagentId"]; ?>"> <button class="btn btn-sm btn-warning"> Edit </button> </a>
                                                    </td>
                                                </tr>
                                            <?php $j++; endforeach; ?>
                                        </tbody>
