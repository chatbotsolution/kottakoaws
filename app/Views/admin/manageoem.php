                                    ...
                                    <table class="table table-bordered table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
                                                ...
                                                <th style="padding: 10px 10px;">GM Contact</th>
                                            ...
                                            <?php 
                                                ...
                                                foreach($oemdata as $saledata):
													...
													if($saledata["status"] == 0){
                                                        $sts="Active";
                                                        $btn = '<a href="'.base_url().'/secure/updtoemstatus/'.$saledata["oemid"].'/1">  <button class="btn btn-sm btn-danger"> Block </button> </a>';
                                                        $btn1='';
                                                    }else if($saledata["status"] == 1){
                                                        $sts="Blocked";
                                                        $btn='<a href="'.base_url().'/secure/updtoemstatus/'.$saledata["oemid"].'/0">  <button class="btn btn-sm btn-primary"> Un-Block </button> </a>';
                                                        $btn1='';
                                                        ...
                                                        $sts="Request Declined";
                                                        $btn='';
                                                        $btn1='<a href="'.base_url().'/secure/updtstatusothr/'.$saledata["oemid"].'/0">    <button class="btn btn-sm btn-success"> Approve </button> </a>';
                                                    }
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    ...
                                                    <td><?= $saledata["gmcontact"]; ?></td>
                                                    <td><?= $sts; ?></td>
                                                    <td>
													    <?= $btn; ?>
                                                        <a href="<?= base_url(); ?>/secure/manageoem/<?= $saledata["oemid"]; ?>"> <button class="btn btn-sm btn-info"> View </button> </a>
                                                        <?= $btn1; ?>
                                                        <a href="<?= base_url(); ?>/secure/editoem/<?= $saledata["oemid"]; ?>"> <button class="btn btn-sm btn-warning"> Edit </button> </a>
                                                        <a href="<?= base_url(); ?>/secure/addpayment/<?= $saledata["oemid"]; ?>"> <button class="btn btn-sm btn-warning"> Add Payment </button> </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
