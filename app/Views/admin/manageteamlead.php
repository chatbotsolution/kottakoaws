                                            ...
                                            <?php 
                                                ...
                                                foreach($teamlead as $saledata):
                                                    ...
                                                    if($saledata["status"] == 0){
                                                        $sts="Active";
                                                        $btn='<a href="'.base_url().'/secure/updtstatusothr/'.$saledata["teamleadId"].'/1">    <button class="btn btn-sm btn-danger"> Block </button> </a>';
                                                        $btn1='';
                                                    }else if($saledata["status"] == 1){
                                                        $sts="Blocked";
                                                        $btn='<a href="'.base_url().'/secure/updtstatusothr/'.$saledata["teamleadId"].'/0">    <button class="btn btn-sm btn-primary"> Un-Block </button> </a>';                                                        
                                                        $btn1='';
                                                        ...
                                                        $btn='';
                                                        $btn1='<a href="'.base_url().'/secure/updtstatusothr/'.$saledata["teamleadId"].'/0">    <button class="btn btn-sm btn-success"> Approve </button> </a>';
                                                    }
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?= $btn1; ?>
                                                        <a href="<?= base_url(); ?>/secure/editteamlead/<?= $saledata["teamleadId"]; ?>"> <button class="btn btn-sm btn-warning"> Edit </button> </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
