					...
					<div class="row">
                        ...
                        <div class="card row">
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
                                    <div>
										<h6 class="card-title mb-1 card-flt">Update sales manager</h6>
									</div>
                                    <?php foreach($editprofileData as $usr); ?>
                                    
									<form action ="<?= base_url(); ?>/secure/editsalesmanager/<?= $usr["salesManagerId"]; ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Profile Image</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="profileimg" value="<?= set_value('profileimg'); ?>" class="form-control mg-b-10" style="max-width:50%;">
                                                <input type="hidden" value="<?= $usr["salesManagerId"]; ?>" name="uppddtid">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="emailidd" value="<?= $usr["salesmngremailid"]; ?>" Placeholder="Email Id" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="regnofsale" value="<?= $usr["regionOfSale"]; ?>" Placeholder="Region Of Sale" class="form-control mg-b-10" style="max-width:50%;">
                                                        ...
                                                        <div class="col-md-2" style="margin-bottom:15px;">
                                                            <span style="border: 1px solid #ebebeb;padding: 5px;float: left;width: 100%;text-align: center;">
                                                              <?php if(sizeof($selectedproduct) != 0){
                                                                     for($jk =0; $jk < sizeof($selectedproduct); $jk++){
                                                                         if($selectedproduct[$jk]["productid"] == $product[$ij]["productid"]){ $ab = "checked";}
                                                                     }?>
                                                                <input type="checkbox" <?php echo $ab; ?> value="<?= $product[$ij]["productid"]; ?>" name="productcode[]"> <lable> <?= $product[$ij]["prodctCode"]; ?> </lable>
                                                              <?php }else{ ?>
                                                                <input type="checkbox" value="<?= $product[$ij]["productid"]; ?>" name="productcode[]"> <lable> <?= $product[$ij]["prodctCode"]; ?> </lable>
                                                              <?php } ?>
                                                            </span>
                                                        </div>
                                                    <?php
                                        ...
                                        <div class="col-md-12">                                            
											<input type="submit" class="btn btn-main-primary" value="Update Sales Manager">
                                        </div>
									</form>
                                </div>                                    
								</div>
