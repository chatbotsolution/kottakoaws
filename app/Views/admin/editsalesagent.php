					...
					<div class="row">
                        ...
                        <div class="card row">
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
									...
									<form action ="<?= base_url(); ?>/secure/editsalesagent/<?= $usr["salesagentId"]; ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Profile Image</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="profileimg" value="<?= set_value('profileimg'); ?>" class="form-control mg-b-10" style="max-width:50%;">
                                                <input type="hidden" value="<?= $usr["salesagentId"]; ?>" name="uppddtid">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" name="emailid" value="<?= $usr["salesagentmailid"]; ?>" Placeholder="Email" class="form-control mg-b-10" style="max-width:50%;">
                                                <span class="errmsg" style="text-align:left;"> <?php if(isset($validations)){ ?> <?= show_form_error($validations,'emailid'); ?> <?php } ?> </span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">No Of Id Creation Allowed<span style="color: red">*</span></label>
                                            <div class="col-sm-10">
                                                <input type="number" name="noidcrtn" value="<?= $usr["allowedIdCreation"]; ?>" Placeholder="No Of Creation Allowed" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="toll&city" class="form-control mg-b-10" style="max-width:50%;">
                                                     <option value=""> Select Toll Or City</option>
                                                     <option value="Toll" <?php if($usr["toll&city"] == "Toll"): echo "selected"; endif; ?>>Toll</option>
                                                     <option value="City" <?php if($usr["toll&city"] == "City"): echo "selected"; endif; ?>>City</option>
                                                </select>
                                                <span class="errmsg" style="text-align:left;"> <?php if(isset($validations)){ ?> <?= show_form_error($validations,'toll&city'); ?> <?php } ?> </span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Region Of Sale<span style="color: red">*</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" name="regnofsale" value="<?= $usr["region"]; ?>" Placeholder="Region Of Sale" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="col-md-12">                                            
											<input type="submit" class="btn btn-main-primary" value="Update Sales Agent">
                                        </div>
									</form>
                                </div>                                    
								</div>
