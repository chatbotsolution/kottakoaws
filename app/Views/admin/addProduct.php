							...
							<div class="card row">
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
									...
									<form action ="<?= base_url(); ?>/secure/addProduct" method="post" autocomplete="off" enctype='multipart/form-data'?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="clsvehcl" class="form-control" style="max-width:50%;">
                                                    ...
                                                    ?>
                                                          <option value="<?= $vehclclass["classofbarcode"]; ?>"><?= $vehclclass["classofbarcode"]; ?></option>
                                                    <?php
                                                       endforeach;
                                                    ?>  
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" style="font-weight: 500;">Hitchpay Price<span style="color: red">*</span></label>
                                            <div class="col-sm-10">
                                                <input type="number" name="price" value="<?= set_value('price'); ?>" Placeholder="Hitchpay Price" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row" hidden>
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="initialamt" value="0" Placeholder="Initial Amount" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="minamount" value="<?= set_value('minamount'); ?>" Placeholder="Minimum Amount" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="depositamnt" value="<?= set_value('depositamnt'); ?>" Placeholder="Deposit Amount" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="cardcost" value="<?= set_value('cardcost'); ?>" Placeholder="Card Cost" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="totalcost" value="<?= set_value('totalcost'); ?>" Placeholder="Total Cost" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="cbscost" value="<?= set_value('cbscost'); ?>" Placeholder="CBS Cost" class="form-control mg-b-10" style="max-width:50%;">
                                                <span class="errmsg" style="text-align:left;"> <?php if(isset($validations)){ ?> <?= show_form_error($validations,'cbscost'); ?> <?php } ?> </span>
                                            </div>
                                        </div>
                                      
                                        <div class="col-md-12">                                            
											<input type="submit" class="allocated-button btn btn-info" value="Add Product">
                                        </div>
									</form>                                    
                                </div>                                    
								</div>
