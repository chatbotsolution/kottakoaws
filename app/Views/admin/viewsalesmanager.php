                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center"> 
                                            <img src ="<?= base_url(); ?>/public/adminasset/img/salesmanager/profileimage/<?php if($profileData["ProfileImage"] == "default"){ echo"default_user.jpg"; }else{ echo $profileData["ProfileImage"]; }; ?>" style="width:300px;">
                                        </div>
                                    </div>
                                    <div>
									...
									<div class="row nc">
										<div class="col-md-6">
											<p> Registration Number <span><?= $profileData["RegdNum"]; ?></span> </p>											
										</div>
										<div class="col-md-6">										
										</div>
										<div class="col-md-6">
										...
										<div class="col-md-6">
											<p> Email Id <span><?= $profileData["salesmngremailid"]; ?></span> </p>											
										</div>
										<div class="col-md-6">
										...
										<div class="col-md-6">
											<p> Region Of Sale <span><?= $profileData["regionOfSale"]; ?></span> </p>											
										</div>
										<div class="col-md-6">
									...
									<div>
										<h6 class="card-title mb-1 card-flt">KYC Details
											<?php
												if($profileData["kycStatus"] == 0 && $_SESSION["logged_intype"] == 1)
												{
											?>
									...
									<div class="row nc">
										...
										<div class="col-md-6">
											<p> Aadhar Card Document <span> <a href="<?= base_url(); ?>/public/adminasset/img/salesmanager/aadharcard/<?= $profileData["aadharProof"]; ?>" download> <i class="fa fa-download" title="Download File"></i> </a> </span> </p>											
										</div>
										<div class="col-md-6">
											<p> PAN Card Number <span><?= $profileData["panCardNumber"]; ?></span> </p>											
										</div>
										<div class="col-md-6">
											<p> PAN Card Document <span> <a href="<?= base_url(); ?>/public/adminasset/img/salesmanager/pancard/<?= $profileData["panCardProof"]; ?>" download> <i class="fa fa-download" title="Download File"></i> </a> </span> </p>											
										</div>
										<div class="col-md-6">
											<p> Driving Licence <span><?= $profileData["drivingLicenceNumber"]; ?></span> </p>											
										</div>
										<div class="col-md-6">
											<p> Driving Licence Document <span> <a href="<?= base_url(); ?>/public/adminasset/img/salesmanager/drivinglicence/<?= $profileData["drivingLicenceProof"]; ?>" download> <i class="fa fa-download" title="Download File"></i> </a> </span> </p>											
										</div>
										<div class="col-md-6">
									...
									<div>
									    ...
									    <?php
										     if($profileData["bankkycStatus"] == 0 && $_SESSION["logged_intype"] == 1)
											 {
										?>
										    <span style="float:right;"> <button class="btn btn-sm btn-success">VEIFY</button> </span>
										<?php 
									...
									<div class="row nc">
										...
										<div class="col-md-6">
											<p> Id Proof <span> <a href="<?= base_url(); ?>/public/adminasset/img/salesmanager/nomeedata/<?= $profileData["idProof"]; ?>" download> <i class="fa fa-download" title="Download File"></i> </a> </span> </p>											
										</div>
									</div>
