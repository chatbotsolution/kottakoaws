							...
							<div class="card row">
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
									...
									<form action ="<?= base_url(); ?>/secure/addsalesmanager" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" style="font-weight: 500;">Operating State<span style="color: red">*</span></label>
                                            <div class="col-sm-10">
                                                <select name="regnofsale" id="regnofsale" class="form-control" style="max-width:50%;"><!-- name="state" id="state" -->
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" style="font-weight: 500;">FASTag Product<span style="color: red">*</span></label>
                                            <div class="col-sm-6">
                                               <div class="row">
                                                   <?php
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" style="font-weight: 500;">Driving Licence Details<span style="color: red">*</span></label>
                                            <div class="col-sm-5"> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="reltnwthmngr" style="max-width:50%; font-weight: 450;">
                                        ...
                                        <div class="col-md-12">                                            
											<input type="submit" class="allocated-button btn btn-info" value="Add Sales Manager">
                                        </div>
									</form>
                                </div>                                    
								</div>
