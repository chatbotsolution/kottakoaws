                                    ...
                                    <table class="table table-bordered table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
                                                ...
                                                <th style="padding: 10px 10px;">Requested By Regd No</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <a href="<?= base_url(); ?>/secure/updtoemstatus/<?= $saledata["oemid"]; ?>/0">    <button class="btn btn-sm btn-success"> Approve </button> </a>
                                                    <a href="<?= base_url(); ?>/secure/updtoemstatus/<?= $saledata["oemid"]; ?>/3">    <button class="btn btn-sm btn-danger"> Decline </button> </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
