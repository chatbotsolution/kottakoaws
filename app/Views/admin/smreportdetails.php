                                      ...
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          ...
                                          <?php
                                             if($typ == 0){
                                          ?>
                                            <form action ="<?= base_url(); ?>/secure/smreportdetails/<?= $slctid; ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                          <?php     
                                             }else{
                                          ?>
                                            <form action ="<?= base_url(); ?>/secure/smextreportdetails/<?= $slctid; ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                          <?php                                               
                                             }
                                           ?>
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">  
                                          ...
                                          <a href="<?= base_url(); ?>/secure/smdownload/<?= $dwn; ?>/<?= $slctid; ?>">
                                          ...
                                          ?>
                                              <?php if($typ == 0){ $dwn = "new"; }else if($typ == 1){ $dwn = "existing"; } ?>
                                              <a href="<?= base_url(); ?>/secure/smsrchdownload/<?= $dwn; ?>/<?= $slctid; ?>/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                <button class="btn btn-sm btn-info">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $saledata["target"]; ?></td>
                                                    <td><?= $salessize[$j]; ?></td>
                                                    <td>
                                                      <a href="<?= base_url(); ?>/<?= $link; ?>/<?= $saledata["teamleadId"]; ?>"> <button class="btn btn-sm btn-info"> View Report </button> </a>
                                                    </td>
                                                </tr>
                                            <?php $j++; endforeach; ?>
                                        </tbody>
