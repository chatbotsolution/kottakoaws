                                  ...
                                  <div class="col-lg-12 col-md-12" style="margin-top:0px;">
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          ...
                                          <form action ="<?= base_url(); ?>/salesmanager/srchhindvext/<?php print_r($rqstby); ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <a href="<?= base_url(); ?>/salesmanager/downloadreportindvlext/<?php print_r($rqstby); ?>">
                                          ...
                                          ?>
                                              <a href="<?= base_url(); ?>/salesmanager/downloadreportinext/<?php print_r($rqstby); ?>/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                <button class="btn btn-sm btn-info">
