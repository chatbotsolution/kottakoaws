                                     ...
                                     <div class="col-lg-12 col-md-12" style="margin-top:0px;">
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          ...
                                          <form action ="<?= base_url(); ?>/salesmanager/searchdate/<?php print_r($rqstby); ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <a href="<?= base_url(); ?>/salesmanager/downloadindvtl/<?php print_r($rqstby); ?>">
                                          ...
                                          ?>
                                              <a href="<?= base_url(); ?>/salesmanager/downloadreportnewdate/<?php print_r($rqstby); ?>/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                <button class="btn btn-sm btn-info">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <?php $date = date("Y-m-d"); $day_before = date( 'Y-m-d', strtotime( $date . ' -1 day' ) ); ?>
                                          <form action ="<?= base_url(); ?>/salesmanager/existingcustomertlextreport/<?php print_r($rqstby); ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                            <div class="form-group row">
                                              <label class="col-sm-2 col-form-label" style="font-weight: 500">Start Date</label>
                                              <div class="col-sm-10">
                                                <input type="date" name="dtstrt" value="<?= set_value('dtstrt'); ?>" class="form-control mg-b-10" max="<?= date("Y-m-d"); ?>">
                                        ...
                                        <div class="col-md-6" style="margin-bottom:20px;float:right;">                                          
                                          <a href="<?= base_url(); ?>/salesmanager/downloadindvtlexisting/<?php print_r($rqstby); ?>">
                                            <button class="btn btn-sm btn-info">
                                                Download Report (PDF)
                                            </button>
                                          </a>
                                          <?php
                                             if(isset($datadatebetween)){
                                          ?>
                                              <a href="<?= base_url(); ?>/salesmanager/existingcustomertlextreportdwn/<?php print_r($rqstby); ?>/<?= $datadatebetween[0]; ?>/<?= $datadatebetween[1]; ?>">
                                                <button class="btn btn-sm btn-info">
                                                  Download Report ( <?= date("d-m-Y", strtotime($datadatebetween[0])); ?> Till <?= date("d-m-Y", strtotime($datadatebetween[1])); ?> )
                                                </button>
                                              </a>
                                    ...
                                    <table class="table table-bordered table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
                                                ...
                                                <th style="padding: 10px 10px;">Total Tag Activated</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $sts; ?></td>
                                                      <?php
                                                         if($typp == 0){
                                                      ?>                                                       
                                                           <td> <a href="<?= base_url(); ?>/salesmanager/newcustomerreport/<?= $saledata["salesagentId"]; ?>"> <button class="btn btn-sm btn-info"> View Report </button> </a> </td>
                                                      <?php
                                                         }else{
                                                      ?>
                                                           <td> <a href="<?= base_url(); ?>/salesmanager/existingcustomerreport/<?= $saledata["salesagentId"]; ?>"> <button class="btn btn-sm btn-info"> View Report </button></a></td>
                                                      <?php
                                                         }
                                                      ?> 
                                                </tr>
