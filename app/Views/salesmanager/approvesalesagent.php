                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <a href="<?= base_url(); ?>/salesmanager/updtsalesagentstatus/<?= $saledata["salesagentId"]; ?>/0">    <button class="btn btn-sm btn-success"> Approve </button> </a>
                                                    <a href="<?= base_url(); ?>/salesmanager/updtsalesagentstatus/<?= $saledata["salesagentId"]; ?>/3">    <button class="btn btn-sm btn-danger"> Decline </button> </a>
                                                    </td>
                                                </tr>
                                          <?php } endforeach; ?>
                                        </tbody>
