                                    ...
                                    <table class="table table-bordered table-data" id="users-list">
                                        <thead style="background-color: #FFAFAF; border: 1px solid black;">
                                            <tr>
												...
												<th style="padding: 10px 10px;">Registration Number</th>
                                                <th style="padding: 10px 10px;">Name</th>
                                                <th style="padding: 10px 10px;">Sales Agent Email</th>
                                                <th style="padding: 10px 10px;">Toll OR City</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $saledata[0]["salesAgentRegdNum"]; ?></td>
                                                    <td><?= $saledata[0]["Fname"].' '.$saledata[0]["Lname"]; ?></td>
                                                    <td><?= $saledata[0]["salesagentmailid"]; ?></td>
                                                    <td><?= $saledata[0]["toll&city"]; ?></td>
                                                  ...
                                                  <td><?php if($oemreqst[$j]["status"] == 0){ echo"Pending";}else if($oemreqst[$j]["status"] == 1){ echo"Approved"; }else if($oemreqst[$j]["status"] == 2){ echo"Rejected"; } ?></td>
                                                    ...
                                                    ?>
                                                    <a href="<?= base_url(); ?>/salesmanager/updtreqstoemstatus/<?= $oemreqst[$j]["fastagrequestid"]; ?>/1">    <button class="btn btn-sm btn-success"> Approve </button> </a>
                                                    <a href="<?= base_url(); ?>/salesmanager/updtreqstoemstatus/<?= $oemreqst[$j]["fastagrequestid"]; ?>/2">    <button class="btn btn-sm btn-danger"> Decline </button> </a>
                                                    <?php
                                                      }
													?>
                                                    </td>
