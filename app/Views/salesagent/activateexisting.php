               ...
               -->	
						...
						<div class="row" style="margin-top: 10px;">
                             <div class="col-lg-12 col-md-12">
							  <div class="card row" style="width:98%;margin-left:15px;">
								<div class="card-body">
									<div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
										...
										<form action ="<?= base_url(); ?>/salesagent/tagactivationexisting" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="col-md-12 text-center">
                                                          <?php
                                                              ...
                                                              if($pending >= 250){
                                                                echo'<input type="button" class="btn btn-main-primary" id="submit_frm" value="Make Payment & Activate Tag">';
                                                              }else if($pending < 250){
...
<script>
	...
	function shwClassTag(val){
		var shwclssTag = val;
			$.ajax({
				type:'POST',
				url:'<?= base_url(); ?>/salesagent/tagactivationexisting',
  ...
  $(document).on('click','#submit_frm',function (event) {
    ...
    if(prd != ""){
      ...
      var typee = "";
        ...
        $.ajax({
            url: "<?= base_url(); ?>/salesagent/activatinguser",
            data: formData,
            processData: false,
            contentType: false,
            type: 'POST',
