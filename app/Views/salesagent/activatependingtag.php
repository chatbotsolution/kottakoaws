                                ...
                                <?php } ?>
                                    ...
                                    <table class="table-data table table-bordered" id="users-list">
                                        ...
                                        <tbody>
                                            <?php 
                                                $i=0;
                                                foreach($teamleadmanagerprd as $saledata):
                                                    $i++;
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    ...
                                                    <td> 
                                                      <?php
                                                            ...
                                                            if($saledata["tokennumber"] !="" || $saledata["customerid"] !="" && $saledata["agenttype"] !=""){
                                                       ?>
                                                      	   <a href="<?= base_url(); ?>/salesagent/pendingtagActivation/<?= $saledata["initialId"]; ?>">                                                      
