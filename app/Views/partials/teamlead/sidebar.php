<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="<?= base_url(); ?>/teamlead/addsalesagent"> Add Field Sales Executive </a></li>
      	...
      	<li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="<?= base_url(); ?>/teamlead/newcustomerreport"> New Customer Report </a></li>
                <li><a class="slide-item" href="<?= base_url(); ?>/teamlead/existingcustomerreport"> Existing Customer Report </a></li>
            </ul>
        </li>
