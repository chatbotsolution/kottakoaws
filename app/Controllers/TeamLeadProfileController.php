...
class TeamLeadProfileController extends BaseController
{
    public $profileModel;
    public $session;
    ...
    public function __construct(){
        helper("form");
        $this->profileModel = new TeamLeadModel();
    ...
    public function editProfile(){
        ...
        if($this->request->getMethod() == "post"){
            if($this->validate($rules)){
                ...
                $alldata = $this->profileModel->showprofiledetails1($_SESSION["teamleadId"]);
                ...
                if($this->request->getFile('aadharproof')){
                    ...
                    $this->session->set('logged_img',$profileImage);
                        ...
                        return redirect()->to(base_url('teamlead/editprofile'));
        ...
        $data['editprofileData'] = $this->profileModel->showprofiledetails($_SESSION["teamleadId"]);
        
        return view('teamlead/editProfile',$data);
    ...
    public function viewProfile(){
        ...
        $data['profileData'] = $this->profileModel->showprofiledetails1($_SESSION["teamleadId"]);
        

        return view('teamlead/profile',$data);
    }
