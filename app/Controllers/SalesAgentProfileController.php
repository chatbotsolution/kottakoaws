...
class SalesAgentProfileController extends BaseController
{
    public $profileModel;
    public $session;
    ...
    public function __construct(){
        helper("form");
        $this->profileModel = new SalesAgentModel();
    ...
    public function viewProfile(){
        ...
        $data['profileData'] = $this->profileModel->showprofiledetails1($_SESSION["salesagentId"]);
        
        

        return view('salesagent/profile',$data);
    }
