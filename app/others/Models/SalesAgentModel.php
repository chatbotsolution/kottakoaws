...
class SalesAgentModel extends Model{
    ...
    public function findSelect($data){
        $builder = $this->db->table('salesagent');        
        $builder->select('salesagentId,salesAgentRegdNum,Fname,Lname,ContactPrimary,ContactSecondary,ProfileImage,toll&city,allowedIdCreation,bankdetailsid,nomineedetailsid, kycdetailsid,requestedById,status,otp');
