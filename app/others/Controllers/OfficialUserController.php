        ...
        if($this->request->getMethod() == "post"){
            if($this->validate($rules)){
                ...
                if($this->request->getFile('profileimg')){
                    ...
                    $data = ["userid"=>$usrid,"password" =>md5(sha1(md5(sha1($pass)))), "name"=>$name, "email"=>$email,"contact_number"=>$contctnumprim, "image"=>$profileImage, "otp"=>0, "admin_type"=>8, "datetime"=>$dtm, "status"=>0];
