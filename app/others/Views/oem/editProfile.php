					...
					<div class="row">
                        ...
                        <div class="card row">
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
									...
									<form action ="<?= base_url(); ?>/salesagent/editprofile" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Toll Name or City Name<span style="color: red">*</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" name="tollnme" value="<?= $usr["tollname"]; ?>" Placeholder="Toll or City Name" class="form-control mg-b-10" style="max-width:50%;">
                                                <span class="errmsg" style="text-align:left;"> <?php if(isset($validations)){ ?> <?= show_form_error($validations,'tollnme'); ?> <?php } ?> </span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
