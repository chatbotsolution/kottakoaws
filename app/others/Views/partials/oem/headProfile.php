...
<div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="<?= base_url(); ?>/oem/profile"><i class="fa fa-user-circle" aria-hidden="true"></i>Profile</a>
    <!-- <a class="dropdown-item" href="<?= base_url(); ?>/oem/editprofile"><i class="fa fa-cogs" aria-hidden="true"></i> Edit Profile</a> -->
    <a class="dropdown-item" href="<?= base_url(); ?>/oem/logout"><i class="fa fa-sign-out" aria-hidden="true"></i> Sign Out</a>
</div>