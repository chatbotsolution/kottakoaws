...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <div><img src=""></div>
            ...
            <form action="<?=base_url(); ?>/teamleadLogin" method="post">
                    <h2 class="text-danger text-center mr-5">Team Lead Login</h2>
...
<script>
    ...
    function sendOtp(){
        ...
        if(usrid == ""){
            ...
            $.ajax({
                type:'post',
                url:'<?= base_url(); ?>/teamlead/sendotp',
                data:{usrid:usrid},
                success:function(data){
                    if(data =="invalid"){
                        $(".usrerrmsg").html("Invalid Team Lead Id");
                    }else if(data =="sorry"){
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data =="invalid"){
                        ...
                        $("#shwwhr").html("<span style='color:red;font-weight:700;font-size:12px;'> Account Inactive!! Contact Admin </span>");
                    }else{
                        $(".usrerrmsg").html("");
                        $("#userName").attr("readonly","readonly");
                        $("#shwwhr").html(data);
