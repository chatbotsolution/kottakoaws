            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="service-wrappper">
                        <img src="<?= base_url(); ?>/public/assets/images/service/1.jpg" alt="">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="service-wrappper">
                        <img src="<?= base_url(); ?>/public//images/service/2.jpg" alt="">
                        <div class="service-contents">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="service-wrappper">
                        <img src="<?= base_url(); ?>/public/assets/images/service/3.jpg" alt="">
                        <div class="service-contents">
                            <h3><a href="service-details.html">Exchange Bitcoin</a></h3>
                            <p>There are many variations of passages of an Lorem Ipsum available but the about majority have suffered alteration dummy now.</p>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="service-wrappper">
                        <img src="<?= base_url(); ?>/public/assets/images/service/4.jpg" alt="">
                        <div class="service-contents">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="service-wrappper">
                        <img src="<?= base_url(); ?>/public/assets/images/service/5.jpg" alt="">
                        <div class="service-contents">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="service-wrappper">
                        <img src="<?= base_url(); ?>/public/assets/images/service/6.jpg" alt="">
                        <div class="service-contents">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="nvestments-img">
                        <img src="<?= base_url(); ?>/public/assets/images/bg/1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        ...
                        <img src="<?= base_url(); ?>/public/assets/images/line.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?= base_url(); ?>/public/assets/images/team/1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?= base_url(); ?>/public/assets/images/team/2.jpg" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?= base_url(); ?>/public/assets/images/team/3.jpg" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?= base_url(); ?>/public/assets/images/team/4.jpg" alt="">
                        </div>
                        <div class="team-content">
