                                ...
                                <?php } ?>
                                    ...
                                    <table class="table table-bordered" id="users-list">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td> <div id="itemForm"> <?php if($saledata["status"] == 0){ ?> <input type="checkbox" name="checkedtogive" id="checkedtogive<?= $saledata["fasttagid"]; ?>" value="<?= $saledata["fasttagid"]; ?>"> <?php } ?> <?= $i; ?> </div> </td>
									...
									<button class="btn btn-sm btn-info" onclick="sendtag('checkedtogive');">
										Send Tag
									</button>
                                </div>
