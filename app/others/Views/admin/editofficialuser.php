						...
						<div class="col-lg-12 col-md-12">
							<div class="card row">
                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
                                    <div>
										<h6 class="card-title mb-1 card-flt">Edit User</h6>
									</div>
                                    <?php foreach($users as $usr); ?>
									<form action ="<?= base_url(); ?>/secure/editofficialusers/<?= $usr["admin_id"]; ?>" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Profile Image</label>
                                            <div class="col-sm-10">
                                                <input type="file" name="profileimg"  class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="usrid" value="<?= $usr["userid"]; ?>" Placeholder="Login User Id" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="fname" value="<?= $usr["name"]; ?>" Placeholder="First Name" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" onkeypress="if(this.value.length == 10){return false;}" name="contctnumprim" value="<?= $usr["contact_number"]; ?>" Placeholder="Contact Number" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" name="email" value="<?= $usr["email"]; ?>" Placeholder="Email" class="form-control mg-b-10" style="max-width:50%;">
                                                <span class="errmsg" style="text-align:left;"> <?php if(isset($validations)){ ?> <?= show_form_error($validations,'email'); ?> <?php } ?> </span>
                                            </div>
                                        </div>
                                        <div class="col-md-12">                                            
											<input type="submit" class="btn btn-main-primary" style="width:10%;" value="Update User">
                                        </div>
									</form>
                                </div>                                    
								</div>
