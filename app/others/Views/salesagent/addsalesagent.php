                                ...
                                <div class="col-lg-12 col-md-12" style="padding-bottom: 50px;">	
									...
									<form action ="<?= base_url(); ?>/teamlead/addsalesagent" method="post" autocomplete="off" enctype="multipart/form-data" ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="tollnme" value="<?= set_value('tollnme'); ?>" Placeholder="Toll or City Name" class="form-control mg-b-10" style="max-width:50%;">
                                        ...
                                        <div class="col-md-12">                                            
											<input type="submit" class="btn btn-main-primary" style="width:10%;" value="Add Sales Agent">
                                        </div>
									</form>
                                </div>                                    
								</div>
