...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <div><img src=""></div>
            ...
            <form action="<?=base_url(); ?>/salesmanagerLogin" method="post">
                    <h2 class="text-danger text-center mr-5">Sales Manager Login</h2>
...
<script>
    ...
    function sendOtp(){
        ...
        if(usrid == ""){
            ...
            $.ajax({
                type:'post',
                url:'<?= base_url(); ?>/salesmanager/sendotp',
                data:{usrid:usrid},
                success:function(data){
                    if(data =="invalid"){
                        $(".usrerrmsg").html("Invalid Salesmanager Id");
                    }else if(data =="sorry"){
